...
function DailyVerse() {
  ...
  return (
    <section style={{padding: '0 2rem 3rem', maxWidth: '1100px', margin: '0 auto'}}>
      <div style={{background: '#8b0e0e', borderRadius: '6px', padding: '2.5rem', textAlign: 'center', borderTop: '4px solid #c9a030', position: 'relative', overflow: 'hidden'}}>
        <p style={{fontFamily: 'Georgia, serif', fontSize: 'clamp(1.1rem, 2.5vw, 1.5rem)', color: 'white', lineHeight: '1.7', marginBottom: '0.75rem', position: 'relative', zIndex: 1}}>
          "{verse.text}"
        </p>
    ...
    <main className="min-h-screen" style={{fontFamily: 'Inter, sans-serif'}}>
      ...
      <section style={{
        ...
        <div style={{maxWidth: '580px'}}>
          ...
          <h1 style={{fontFamily: 'Georgia, serif', fontSize: 'clamp(2rem, 4vw, 3rem)', color: 'white', lineHeight: '1.2', marginBottom: '0.75rem'}}>Faith. Martyrdom. <span style={{color: '#f0c84a'}}>Community.</span></h1>
      ...
      <section style={{padding: '3rem 2rem', maxWidth: '1100px', margin: '0 auto'}}>
        ...
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem'}}>
          {[
            ...
            {icon: '📍', title: 'Visit/Contact Us', sub: 'Umlazi G, South Africa', href: '/contact'},
          ].map((item) => (
            <a key={item.href} href={item.href} style={{background: '#8b0e0e', color: 'white', borderRadius: '6px', padding: '1.25rem', textDecoration: 'none', borderBottom: '3px solid #c9a030', display: 'block'}}>
