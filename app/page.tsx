...
function DailyVerse() {
  ...
  return (
    <div style={{background: '#8b0e0e', borderRadius: '6px', padding: '2rem', textAlign: 'center', borderTop: '4px solid #c9a030', position: 'relative', overflow: 'hidden'}}>
      <p style={{fontFamily: 'Georgia, serif', fontSize: 'clamp(1rem, 2.5vw, 1.4rem)', color: 'white', lineHeight: '1.7', marginBottom: '0.75rem'}}>"{verse.text}"</p>
      <p style={{color: '#f0c84a', fontSize: '13px', fontWeight: '500'}}>{verse.reference}</p>
      <p style={{color: 'rgba(255,255,255,0.4)', fontSize: '11px', marginTop: '0.5rem'}}>Verse of the day — changes daily</p>
    </div>
  )
}
...
export default function Home() {
  const quickLinks = [
    ...
    {icon: '🖼️', title: 'Gallery', sub: 'Parish photos', href: '/gallery'},
    {icon: '📅', title: 'Calendar', sub: 'Feasts & events', href: '/calendar'},
    ...
    <main style={{fontFamily: 'Inter, sans-serif'}}>
      ...
      <section style={{
        ...
        <div style={{maxWidth: '580px'}}>
          <div style={{background: '#c9a030', color: '#8b0e0e', fontSize: '11px', letterSpacing: '3px', textTransform: 'uppercase', padding: '5px 14px', borderRadius: '2px', display: 'inline-block', marginBottom: '1.2rem', fontWeight: '600'}}>Welcome Home</div>
          <h1 style={{fontFamily: 'Georgia, serif', fontSize: 'clamp(2rem, 4vw, 3rem)', color: 'white', lineHeight: '1.2', marginBottom: '0.75rem'}}>
            Faith. Martyrdom. <span style={{color: '#f0c84a'}}>Community.</span>
          </h1>
          ...
          <div style={{display: 'flex', gap: '0.75rem', flexWrap: 'wrap'}}>
            <a href="/bookings" style={{background: '#c9a030', color: '#8b0e0e', padding: '11px 26px', borderRadius: '3px', fontSize: '13px', fontWeight: '500', textDecoration: 'none'}}>Book an Event</a>
            <a href="/streams" style={{background: 'transparent', color: 'white', border: '1.5px solid rgba(255,255,255,0.5)', padding: '11px 26px', borderRadius: '3px', fontSize: '13px', textDecoration: 'none'}}>Watch Live</a>
          </div>
        </div>
      </section>
      ...
      <section style={{padding: '0 2rem 2.5rem', maxWidth: '1100px', margin: '0 auto'}}>
        <p style={{fontSize: '11px', background: '#fff8e7', border: '1px solid #c9a030', color: '#8b0e0e', padding: '4px 12px', borderRadius: '2px', display: 'inline-block', marginBottom: '1.5rem', fontWeight: '600', letterSpacing: '1px'}}>EST. 1971 — UMLAZI, SOUTH AFRICA</p>
